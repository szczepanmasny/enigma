<template>
  <div>
    ...
    <p>Kolor: <strong>{{content.color}}</strong></p>
    <p>Numer rejestracyjny: <strong>{{content.platesNumber}}</strong></p>
    <p>Numer boczny: <strong>{{content.sideNumber}}</strong></p>
  </div>
</template>
...
<script>
  export default {
    ...
    statuses: {"AVAILABLE":"Dostępny","RETURNED":"Zwrócony","RENTED":"Wypożyczony","UNAVAILABLE":"Niedostępny","RESERVED":"Zarezerwowany"},
      };
    },
    computed: {
